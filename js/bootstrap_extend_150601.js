...
//            }
            ...
            var animateName2 = 'fadeIn animated';
            $(".fadeIn").removeClass(animateName2);
            animateName2 = 'fadeIn3 animated';
            $(".fadeIn3").removeClass(animateName2);

            if (!$(target).is("[AnimationHard-index]")) {
        ...
        AnimationAct: function (target, animateName, count, during) {
            ...
            var mosueEnter = $("#section_1").attr("mouseenter");
            console.log(current + "," + during + "," + (index % count));
             if (mosueEnter == "false") {
            $(current).show().removeClass(animateName).addClass(animateName).one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
                setTimeout(function () {
                    if (target != ".icon") {
