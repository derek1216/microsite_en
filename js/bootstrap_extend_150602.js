...
//            }
            ...
            setInterval(function () {
                ...
                if (mosueEnter == "false") {
                    ...
                    if (target != ".icon") {
                        $(before).removeClass(animateName).addClass("fadeOut animated").one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
                            $(before).removeClass("fadeOut animated");
                        });
                    }
                    index++;
