...
<html lang="en">
    <head>
        ...
        <title>ATEN CM1164 Multi-View Management Solution</title>
        <meta property="og:image" content="http://www.aten.com/data/microsite/cm1164/images/cm1164_facebook.jpg"/>
        <link rel="image_src" type="image/jpeg" href="http://www.aten.com/data/microsite/cm1164/images/cm1164_facebook.jpg" />
        <meta name="description" 
              content="The CM1164 Multi-View DVI-D KVMP&#8482; Switch is the perfect solution for a wide range of applications including traffic control, data monitoring, public surveillance, video editing and more.">

        <meta name="keywords" 
              content="ATEN, CM1164, KVM, KVMP, multi-view, multiview, multi-display, multi display, quad view, pip, Picture in Picture, pbp, Picture by Picture, Fast Switching">
    ...
    <body>
        ...
        <div id="pmenu_block">
            <div id="pmenu_box" class="navbar">
                <div class="container">
                    <span class="brandname brand" href="#" style="white-space: nowrap"><a href="/products/productItem.php?model_no=CM1164" target="_blank">CM1164</a></span>
            ...
            <div class="container">
                ...
                <div class="row-fluid icon_subblock Animation" data-animation="zoomIn">
                    ...
                    <div class="span4 icon_content">
                        <a class="IconAnimation ui-link" target="_blank" href="/products/productItem.php?model_no=CM1164">
                            <div class="row-fluid">
