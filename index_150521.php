...
<html lang="en">
    <head>
        ...
        <title>ATEN Control System - Control Without Complication</title>
        <meta property="og:image" content="http://www.aten.com/ext_data/global_en/ControlSystem/images/control_system_facebook.jpg"/>
        <link rel="image_src" type="image/jpeg" href="http://www.aten.com/ext_data/global_en/ControlSystem/images/control_system_facebook.jpg" />
        <meta name="description" 
              content="The ATEN Control System, incorporating the VK2100 (ATEN Controller), the VK6000 (ATEN Configurator) and the ATEN Control System App, is a standard Ethernet-based management system that connects all hardware devices in a room or large facility to provide centralized control of devices directly and effortlessly via iPad.">

        <meta name="keywords" 
              content="ATEN Control System,  VK2100, VK6000, control system app, control app, controller, configurator software, control system, automation control, meeting device control, meeting equipment control, meeting control, ATEN VanCryst">
        ...
        <script type="text/javascript" charset="utf-8" src="js/jquery.flip.js"></script>
    ...
    <body>
        ...
        <div id="pmenu_block">
            <div id="pmenu_box" class="navbar">
                <div class="container">
                    <span class="brandname brand" href="#" style="white-space: nowrap"><a href="/products/Professional-Audio/Video/Control-System/ATEN-Control-System--ATEN-Controller~VK2100.html#.VS9TjJNBnDQ" target="_blank">ATEN Microsite Template</a></span>
                        ...
                        <div id="pmenu" class="nav-function collapse nav-collapse navCollapseToggle">
                            <nav class="row">
                                <ul class="nav highlights" style="left:10px\9;">
                                    ...
                                    <li><a href="?Solution" target="_self">Solution</a></li>
        ...
        <div style="" id="content"> <!--content -start -->
            ...
            <div style="z-index: 10000;position: fixed; width: 855px; height: 574px; top: 0px; left: 50%; margin-left: -427.5px; display: none;" id="demoLightbox" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
                <div style="width: 998px; height: 662px;" class="lightbox-content">
                    ...
                    <iframe width="998" height="662" src="http://www.youtube.com/embed/j49pvtL0Hv0?rel=0&wmode=opaque&cc_load_policy=1;vq=hd1080" frameborder="0" allowfullscreen></iframe>
            ...
            <div class="container">
                ...
                <div class="row-fluid icon_subblock Animation" data-animation="zoomIn">
                    ...
                    <div class="span4 icon_content">
                        <a class="IconAnimation ui-link" target="_blank" href="/products/Professional-Audio/Video/Control-System/ATEN-Control-System--ATEN-Controller~VK2100.html#.VTR_C5NBnDS">
                            <div class="row-fluid">
        ...
        <script>
            ...
            $(function () {
                ...
                //$.highlights(top,left);
                $.highlights("-11", "15");
                $.addFBShare("www.aten.com/data/microsite/ControlSystem");
            });
        </script>
        <script>
            $(function () {
                ...
                function recordGA(pos, targetName) {
                    _gaq.push(['_trackEvent', 'Microsite-Control System', pos, targetName]);
                }
            });
